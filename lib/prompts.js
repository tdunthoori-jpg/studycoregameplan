...
- Practice test count by program length:
  - 10 weeks or fewer: 2–3 tests, no closer than 3 weeks apart
  - 11–20 weeks: 3–4 tests, 4–5 weeks apart
  - 21–30 weeks: 4–5 tests, 5–6 weeks apart
  - 31–40 weeks: 5–7 tests, 5–6 weeks apart
- First test no earlier than Week 4. Final test no later than 3 weeks before program end.
...
- Regular weeks: domain-specific drills with question counts — be specific and realistic. A typical regular week has 45–90 minutes of homework total across all items listed.
- Always specify total hours per item
- The programOverview.homework field must state a realistic per-week estimate that matches the actual homework listed in the week cards. Do not overstate — if most weeks have 45–75 minutes, write "45–75 minutes per week", not "2–3 hours".
...
- The programOverview.homework field must match actual week-card homework totals — do not claim "2–3 hours/week" if week cards only assign 45–75 minutes. State the realistic estimate.
