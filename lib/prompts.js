...
export const VISION_EXTRACTION_PROMPT = `Extract ALL score data from this SAT/PSAT score report. Return ONLY valid JSON:
{
  ...
  "domains": {
    "cs": "string performance band or null",
    "ii": "string performance band or null",
    "eoi": "string performance band or null",
    "sec": "string performance band or null",
    "alg": "string performance band or null",
    "am": "string performance band or null",
    "psda": "string performance band or null",
    "gt": "string performance band or null"
  },
  "additionalData": "string — percentiles, selection index, module breakdowns, question-level data, etc."
}`;

export const GENERATION_SYSTEM_PROMPT = `You are StudyCore's SAT game plan generator. You produce structured JSON output that will be converted into a formatted .docx document.
...

{
  ...
  "meetingScript": {
    "opening": { "duration": "2-3 min", "content": "string — specific talking points" },
    "scoreWalkthrough": { "duration": "5-7 min", "content": "string" },
    "opportunity": { "duration": "3-4 min", "content": "string" },
    "programStructure": { "duration": "5-7 min", "content": "string" },
    "targetTimeline": { "duration": "3-4 min", "content": "string" },
    "collegeContext": { "duration": "2-3 min", "content": "string" },
    "close": { "duration": "3-4 min", "content": "string" },
