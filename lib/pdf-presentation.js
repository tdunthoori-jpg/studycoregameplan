    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <div style="flex:1;display:flex;flex-direction:column;gap:48px;justify-content:center;margin-bottom:24px;margin-top:16px;">
        ...
        <div style="padding-top:32px;">
          ...
          <div style="height:80px;background:#E5E7EB;border-radius:8px;position:relative;overflow:visible;">
  ...
  function domainRow(dom, isLast) {
    ...
    return `<div style="flex:1;display:flex;align-items:center;justify-content:space-between;padding:0 24px;${isLast ? '' : 'border-bottom:1px solid #E5E7EB;'}">
      <div style="flex:1;">
        ...
        <div style="font-size:16px;font-weight:500;color:#64748B;font-style:italic;margin-top:3px;font-family:'Inter',sans-serif;">${esc(dom.performance)}</div>
      </div>
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <div style="display:flex;flex-direction:column;gap:20px;flex:1;">
        ...
        <div style="background:${d.strongBg};border-radius:12px;padding:28px 36px;border-left:6px solid ${d.strongColor};flex:1;display:flex;flex-direction:column;justify-content:flex-start;">
          ...
          <div style="font-size:18px;color:#334155;font-family:'Inter',sans-serif;">The stronger section. Now ${esc(d.weakSec)} needs to match it.</div>
        </div>
        <!-- Weak section card -->
        <div style="background:${d.weakBg};border-radius:12px;padding:28px 36px;border-left:6px solid ${d.weakColor};flex:1;display:flex;flex-direction:column;justify-content:flex-start;">
          ...
          <div style="font-size:28px;font-weight:700;color:#1B3A5C;margin-bottom:8px;font-family:'Inter',sans-serif;">The number that changes the application.</div>
          <div style="font-size:18px;color:#334155;font-family:'Inter',sans-serif;">When ${esc(d.weakSec)} reaches ${esc(d.weakIsRW ? d.rwTargetStr : d.mathTargetStr)}, both sections are competitive. The gap is gone.</div>
        </div>
      </div>
    </div>
    ${slideFooter(n, d.totalSlides)}
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:20px;flex:1;margin-bottom:24px;">
        <div style="background:#F3F4F6;border-radius:12px;padding:28px 24px;border-top:6px solid #1B3A5C;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;">
          <div style="font-size:14px;font-weight:700;color:#64748B;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;font-family:'Inter',sans-serif;">WEEKS</div>
          <div style="font-size:80px;font-weight:800;color:#1B3A5C;line-height:1;font-family:'Inter',sans-serif;">${d.weeks}</div>
          <div style="font-size:16px;color:#64748B;margin-top:8px;font-family:'Inter',sans-serif;">program duration</div>
        </div>
        <div style="background:#F3F4F6;border-radius:12px;padding:28px 24px;border-top:6px solid ${teal};text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;">
          <div style="font-size:14px;font-weight:700;color:#64748B;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;font-family:'Inter',sans-serif;">TOTAL HOURS</div>
          <div style="font-size:80px;font-weight:800;color:${teal};line-height:1;font-family:'Inter',sans-serif;">${d.totalHours}</div>
          <div style="font-size:16px;color:#64748B;margin-top:8px;font-family:'Inter',sans-serif;">in-session + test prep</div>
        </div>
        <div style="background:#F3F4F6;border-radius:12px;padding:28px 24px;border-top:6px solid ${d.weakColor};text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;">
          <div style="font-size:14px;font-weight:700;color:#64748B;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;font-family:'Inter',sans-serif;">PHASES</div>
          <div style="font-size:80px;font-weight:800;color:${d.weakColor};line-height:1;font-family:'Inter',sans-serif;">${d.phaseCount}</div>
          <div style="font-size:16px;color:#64748B;margin-top:8px;font-family:'Inter',sans-serif;">each with a clear job</div>
        </div>
        <div style="background:#F3F4F6;border-radius:12px;padding:28px 24px;border-top:6px solid ${d.strongColor};text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;">
          <div style="font-size:14px;font-weight:700;color:#64748B;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;font-family:'Inter',sans-serif;">PRACTICE TESTS</div>
          <div style="font-size:80px;font-weight:800;color:${d.strongColor};line-height:1;font-family:'Inter',sans-serif;">${d.testCount}</div>
          <div style="font-size:16px;color:#64748B;margin-top:8px;font-family:'Inter',sans-serif;">tracking the climb</div>
        </div>
      </div>
    </div>
    ${slideFooter(n, d.totalSlides)}
...
function slide8Phases(d, n) {
  ...
  const cards = phases.map((ph, i) => {
    ...
    return `<div style="border-radius:12px;overflow:hidden;flex:1;display:flex;flex-direction:column;">
      <div style="background:${color};padding:28px 28px;">
        <div style="font-size:13px;font-weight:700;letter-spacing:0.12em;color:rgba(255,255,255,0.7);text-transform:uppercase;font-family:'Inter',sans-serif;">PHASE ${i + 1}</div>
        <div style="font-size:24px;font-weight:700;color:white;margin-top:8px;line-height:1.2;font-family:'Inter',sans-serif;">${esc(ph.shortName || ph.title)}</div>
      </div>
      <div style="background:#F3F4F6;padding:36px 32px;flex:1;display:flex;flex-direction:column;justify-content:center;gap:14px;">
        <div style="display:flex;align-items:flex-end;gap:6px;line-height:1;">
          <span style="font-size:60px;font-weight:800;color:#1B3A5C;line-height:1;font-family:'Inter',sans-serif;">${ph.hours || '—'}</span>
          <span style="font-size:24px;font-weight:600;color:#334155;margin-bottom:8px;font-family:'Inter',sans-serif;">hrs</span>
        </div>
        ${wkLabel ? `<div style="font-size:20px;font-weight:700;color:#334155;font-family:'Inter',sans-serif;">${esc(wkLabel)}</div>` : ''}
        ${ph.season ? `<div style="font-size:16px;color:#64748B;font-family:'Inter',sans-serif;">${esc(ph.season)}</div>` : ''}
      </div>
    </div>`;
  }).join('');
...
function slide10Checkpoints(d, n) {
  ...
  const circles = Array.from({ length: count }, (_, i) => {
    ...
    const labelHtml = `<div style="text-align:center;width:140px;">
      <div style="font-size:17px;font-weight:700;color:#1B3A5C;font-family:'Inter',sans-serif;">Test #${i + 1}</div>
      ${wk ? `<div style="font-size:16px;color:#64748B;font-family:'Inter',sans-serif;">Wk ${wk}</div>` : ''}
      ${score ? `<div style="font-size:20px;font-weight:700;color:${color};margin-top:2px;font-family:'Inter',sans-serif;">${esc(String(score))}</div>` : ''}
      <div style="font-size:16px;font-style:italic;color:#64748B;margin-top:2px;font-family:'Inter',sans-serif;">${esc(job)}</div>
    </div>`;
