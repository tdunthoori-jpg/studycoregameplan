...
function slideHomework(d, n) {
  ...
  const phaseCards = d.phaseHomework.map((ph) => {
    ...
    return `<div style="background:white;border-radius:14px;padding:${cardPad};border-left:6px solid ${ph.color};box-shadow:0 2px 12px rgba(0,0,0,0.06);display:flex;flex-direction:column;overflow:hidden;min-height:0;">
