...
function slide5Scholarships(d, n) {
  ...
  const cards = schools.map(s => {
    ...
    return `<div style="background:white;border-radius:20px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 2px 20px rgba(0,0,0,0.07);border:1px solid #E2E8F0;">
      <div style="background:linear-gradient(135deg,#1A8870,#1F7A50);padding:24px 28px;flex-shrink:0;">
        ...
        <div style="font-size:13px;color:rgba(255,255,255,0.72);margin-top:5px;font-family:'Inter',sans-serif;">${esc(s.program)}</div>
      </div>
  ...
  return `<section style="width:1920px;height:1080px;display:flex;flex-direction:column;position:relative;overflow:hidden;page-break-after:always;">
    ${brandBar(d.firstName, 'SCHOLARSHIPS')}
...
function slide10Checkpoints(d, n) {
  ...
  const nodes = Array.from({ length: count }, (_, i) => {
    ...
    const prevScore = i === 0 ? d.baseline : (d.chartPoints[i]?.score || d.baseline);
  ...
  return `<section style="width:1920px;height:1080px;display:flex;flex-direction:column;position:relative;overflow:hidden;page-break-after:always;">
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:#F8FAFC;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:20px;flex:1;">
        <!-- Card 01: Score jump -->
        <div style="background:linear-gradient(145deg,#E8EEF7,#F0F4FF);border-radius:16px;padding:40px 36px;border-left:6px solid #1B3A5C;box-shadow:0 1px 2px rgba(15,36,64,0.04),0 4px 16px rgba(15,36,64,0.06);display:flex;flex-direction:column;justify-content:center;gap:20px;">
          <div>
            <div style="font-size:64px;font-weight:800;color:#1B3A5C;line-height:1;margin-bottom:18px;font-family:'Inter',sans-serif;">01</div>
            <div style="font-size:24px;font-weight:700;color:#1B3A5C;margin-bottom:18px;font-family:'Inter',sans-serif;">${esc(tierName)} Composite</div>
          ...
          <div style="font-size:20px;font-weight:700;color:#1B3A5C;line-height:1.55;font-family:'Inter',sans-serif;">Both sections competitive. A complete academic profile.</div>
        </div>
        <!-- Card 02: Gap closed -->
        <div style="background:linear-gradient(145deg,#FBE5DD,#FEF0EC);border-radius:16px;padding:40px 36px;border-left:6px solid #B84A2E;box-shadow:0 1px 2px rgba(15,36,64,0.04),0 4px 16px rgba(15,36,64,0.06);display:flex;flex-direction:column;justify-content:center;gap:20px;">
          <div>
            <div style="font-size:64px;font-weight:800;color:#B84A2E;line-height:1;margin-bottom:18px;font-family:'Inter',sans-serif;">02</div>
            <div style="font-size:24px;font-weight:700;color:#1B3A5C;margin-bottom:18px;font-family:'Inter',sans-serif;">Closes the gap</div>
            <div style="display:flex;align-items:center;gap:16px;">
              ...
              <div style="background:rgba(200,85,61,0.08);border-radius:10px;padding:12px 22px;text-align:center;">
                ...
                <div style="font-size:34px;font-weight:800;color:#B84A2E;line-height:1;font-family:'Inter',sans-serif;">${esc(d.weakIsRW ? d.rwTargetStr : d.mathTargetStr)}</div>
              </div>
            </div>
          </div>
          <div style="font-size:20px;font-weight:700;color:#1B3A5C;line-height:1.55;font-family:'Inter',sans-serif;">${esc(d.weakSec)} reaches its target. Both sections now strong.</div>
        </div>
        <!-- Card 03: Schools in range -->
        <div style="background:linear-gradient(145deg,#DCEDE2,#EBF5EE);border-radius:16px;padding:40px 36px;border-left:6px solid #1F7A50;box-shadow:0 1px 2px rgba(15,36,64,0.04),0 4px 16px rgba(15,36,64,0.06);display:flex;flex-direction:column;justify-content:center;gap:20px;">
          <div>
            <div style="font-size:64px;font-weight:800;color:#1F7A50;line-height:1;margin-bottom:18px;font-family:'Inter',sans-serif;">03</div>
            <div style="font-size:24px;font-weight:700;color:#1B3A5C;margin-bottom:18px;font-family:'Inter',sans-serif;">Schools in range</div>
            ${schoolPills}
          </div>
