...
function slide3Diagnosis(d, n) {
  ...
  function targetMarker(targetPct, targetStr, color) {
    ...
    <div style="position:absolute;top:-26px;left:${targetPct}%;transform:translateX(-50%);">
      <span style="font-size:13px;font-weight:700;color:${color};font-family:'Inter',sans-serif;white-space:nowrap;">▼ ${esc(targetStr)}</span>
    </div>`;
  }
  ...
  return `<section style="width:1920px;height:1080px;display:flex;flex-direction:column;position:relative;overflow:hidden;page-break-after:always;">
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <!-- Visual bars -->
      <div style="flex:1;display:flex;flex-direction:column;gap:48px;justify-content:center;margin-bottom:24px;">
        <!-- Math bar -->
        <div>
          ...
          <div style="height:80px;background:#E5E7EB;border-radius:8px;position:relative;">
  ...
  function domainRow(dom, isLast) {
    ...
    return `<div style="flex:1;display:flex;align-items:center;justify-content:space-between;padding:0 24px;${isLast ? '' : 'border-bottom:1px solid #E5E7EB;'}">
      <div style="flex:1;">
        ...
        <div style="font-size:15px;color:#64748B;font-style:italic;margin-top:3px;font-family:'Inter',sans-serif;">${esc(dom.performance)}</div>
      </div>
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <div style="display:flex;flex-direction:column;gap:20px;flex:1;">
        ...
        <div style="background:${d.strongBg};border-radius:12px;padding:28px 36px;border-left:6px solid ${d.strongColor};flex:1;display:flex;flex-direction:column;justify-content:flex-start;">
          ...
          <div style="font-size:16px;color:#334155;font-family:'Inter',sans-serif;">The stronger section. Now ${esc(d.weakSec)} needs to match it.</div>
        </div>
        <!-- Weak section card -->
        <div style="background:${d.weakBg};border-radius:12px;padding:28px 36px;border-left:6px solid ${d.weakColor};flex:1;display:flex;flex-direction:column;justify-content:flex-start;">
          ...
          <div style="font-size:16px;color:#334155;font-family:'Inter',sans-serif;">When ${esc(d.weakSec)} reaches ${esc(d.weakIsRW ? d.rwTargetStr : d.mathTargetStr)}, both sections are competitive. The gap is gone.</div>
        </div>
      </div>
    </div>
    ${slideFooter(n, d.totalSlides)}
...
function slide10Checkpoints(d, n) {
  ...
  const circles = Array.from({ length: count }, (_, i) => {
    ...
    const labelHtml = `<div style="text-align:center;width:140px;">
      ...
      ${wk ? `<div style="font-size:15px;color:#64748B;font-family:'Inter',sans-serif;">Wk ${wk}</div>` : ''}
      ...
      <div style="font-size:15px;font-style:italic;color:#64748B;margin-top:2px;font-family:'Inter',sans-serif;">${esc(job)}</div>
    </div>`;
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:white;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:20px;flex:1;margin-bottom:24px;">
        <div style="background:#E8EEF7;border-radius:12px;padding:32px;border-left:6px solid #1B3A5C;display:flex;flex-direction:column;justify-content:space-between;">
          ...
          <div style="font-size:17px;color:#334155;line-height:1.5;font-family:'Inter',sans-serif;">Both Math and Reading &amp; Writing at a competitive level. A complete academic profile.</div>
        </div>
        <div style="background:#FBE5DD;border-radius:12px;padding:32px;border-left:6px solid #C8553D;display:flex;flex-direction:column;justify-content:space-between;">
          ...
          <div style="font-size:17px;color:#334155;line-height:1.5;font-family:'Inter',sans-serif;">${esc(d.weakSec)} goes from ${d.weakScore} to ${esc(d.weakIsRW ? d.rwTargetStr : d.mathTargetStr)}. Both sections now strong.</div>
        </div>
        <div style="background:#DCEDE2;border-radius:12px;padding:32px;border-left:6px solid #2D8659;display:flex;flex-direction:column;justify-content:space-between;">
          ...
          <div style="font-size:17px;color:#334155;line-height:1.5;font-family:'Inter',sans-serif;">${schoolLine}</div>
        </div>
      </div>
    </div>
    ${slideFooter(n, d.totalSlides)}
