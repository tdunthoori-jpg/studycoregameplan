...
function derive(gamePlan, studentData, studentName) {
  ...
  // School pills only rendered if targetColleges is explicitly provided — never use hardcoded fallbacks
  const competitiveSchools = (targetColleges || '').trim()
    ? (targetColleges || '').split(',').map(s => s.trim()).filter(Boolean).slice(0, 8)
    : [];
...
function lineChartSvg(chartPoints, baseline, target) {
  ...
  chartPoints.forEach((p, i) => {
    ...
    if (p.isTarget) {
      ...
      s += `<text x="${x}" y="${(parseFloat(y) - 24).toFixed(1)}" text-anchor="middle" font-family="Inter,Helvetica Neue,sans-serif" font-size="18" font-weight="700" fill="#2D8659">${p.score}+</text>`;
    } else {
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:#F8FAFC;">
      ...
      <div style="display:flex;flex-direction:column;gap:20px;flex:1;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;flex:1;">
          <!-- Strong section card -->
          <div style="background:linear-gradient(145deg,${d.strongBg},white);border-radius:16px;padding:32px 36px;border-left:6px solid ${d.strongColor};display:flex;flex-direction:column;">
          ...
          <!-- Weak section card -->
          <div style="background:linear-gradient(145deg,${d.weakBg},white);border-radius:16px;padding:32px 36px;border-left:6px solid ${d.weakColor};display:flex;flex-direction:column;">
...
function slide6Plan(d, n) {
  const cadenceRow = d.weeklyCadence
    ? `<div style="background:white;border-radius:14px;padding:22px 36px;border:1px solid #E2E8F0;box-shadow:0 2px 12px rgba(0,0,0,0.04);display:flex;align-items:center;gap:0;">
        ...
        <div style="flex:1;text-align:center;">
          ...
          <div style="font-size:26px;font-weight:800;color:#C8553D;margin-top:4px;font-family:'Inter',sans-serif;">${esc(d.testMonthYear)} SAT</div>
        </div>
      </div>`
    : '';
  ...
  return `<section style="width:1920px;height:1080px;display:flex;flex-direction:column;position:relative;overflow:hidden;page-break-after:always;">
    ...
    <div style="flex:1;padding:48px 80px 80px;display:flex;flex-direction:column;background:#F8FAFC;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:20px;flex:1;margin-bottom:20px;">
  ...
  const cards = phases.map((ph, i) => {
    ...
    return `<div style="border-radius:20px;overflow:hidden;flex:1;display:flex;flex-direction:column;position:relative;background:${color};box-shadow:0 8px 32px rgba(0,0,0,0.15);">
      ...
      <div style="position:relative;padding:40px 36px;flex:1;display:flex;flex-direction:column;">
        ...
        ${ph.shortDesc ? `<div style="font-size:15px;color:rgba(255,255,255,0.75);margin-top:10px;line-height:1.45;font-family:'Inter',sans-serif;flex:1;">${esc(ph.shortDesc)}</div>` : '<div style="flex:1;"></div>'}
        <!-- Divider -->
        ...
        <div style="background:linear-gradient(145deg,#E8EEF7,#F0F4FF);border-radius:16px;padding:32px;border-left:6px solid #1B3A5C;box-shadow:0 4px 20px rgba(0,0,0,0.06);display:flex;flex-direction:column;justify-content:space-between;">
          <div>
            ...
            <div style="display:flex;align-items:center;gap:14px;margin-bottom:14px;">
              ...
              <div style="font-size:26px;font-weight:800;color:#C8553D;font-family:'Inter',sans-serif;">&#8594;</div>
              <div style="background:rgba(45,134,89,0.1);border-radius:10px;padding:10px 18px;text-align:center;">
                <div style="font-size:11px;font-weight:700;color:#2D8659;letter-spacing:0.1em;font-family:'Inter',sans-serif;">GOAL</div>
                <div style="font-size:30px;font-weight:800;color:#2D8659;line-height:1;font-family:'Inter',sans-serif;">${d.target}+</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style="display:flex;align-items:center;gap:14px;margin-bottom:14px;">
              <div style="background:rgba(200,85,61,0.08);border-radius:10px;padding:10px 18px;text-align:center;">
                ...
                <div style="font-size:30px;font-weight:800;color:#C8553D;line-height:1;font-family:'Inter',sans-serif;">${d.weakScore}</div>
              </div>
              <div style="font-size:26px;font-weight:800;color:#C8553D;font-family:'Inter',sans-serif;">&#8594;</div>
              <div style="background:rgba(200,85,61,0.08);border-radius:10px;padding:10px 18px;text-align:center;">
                <div style="font-size:11px;font-weight:700;color:#64748B;letter-spacing:0.1em;font-family:'Inter',sans-serif;">TARGET</div>
                <div style="font-size:30px;font-weight:800;color:#C8553D;line-height:1;font-family:'Inter',sans-serif;">${esc(d.weakIsRW ? d.rwTargetStr : d.mathTargetStr)}</div>
              </div>
            </div>
          </div>
